...
module mux_8(data_result, select, in0, in1, in2, in3, in4, in5, in6, in7);
    input [2:0] select;                       // only need to use 0-2 for 8 bit mux because only go up to 00101 for SRA
